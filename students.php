        ...
        <body>
            ...
            <?php
        		if (isset($_SESSION['userId'])) {
	    			echo '<form class="formCentered2" action="includes/searchstudents.inc.php" method="post">';
	    			...
	    			while ($res = mysqli_fetch_assoc($result_classes)) {
           			...
           			echo '</select>';
	    			echo '<button class="buttonRed" type="submit" name="searchstudents-submit">Select</button>';
	    			echo '</form>';
